...
with col2:
    st.markdown('<div class="main-header" style="display: flex; align-items: center; justify-content: center; gap: 15px;"><span style="font-size: 60px; line-height: 1;">🏀</span> <span>BET AI PRO</span></div>', unsafe_allow_html=True)
